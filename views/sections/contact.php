...
<section id="contact">
  <div class="ct-box">
    ...
    <a href="mailto:ngui@yelidev.ca" class="ct-email">ngui@yelidev.ca</a>
    <div class="socials">
      <a href="https://github.com/ngui27/" class="soc" target="_blank" rel="noopener noreferrer">
      ...
      <a href="#" class="soc" target="_blank" rel="noopener noreferrer">
